...
# This tutorial shows how to use Predict on a Xgboost model.
...
ADLS_MODEL_URI_XGBOOST = "abfss://ajagarwfs@ajagarwdemoadlsg2.dfs.core.windows.net/predict/models/mlflow/xgboost/model_nf10/"
RETURN_TYPES = "float"
...
predictions = spark.sql(
                  """
                      SELECT PREDICT('xgboost_model', *) AS predict FROM data
                  """
              ).show()
